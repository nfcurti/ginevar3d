    ...
    <div id="section2" className="gsap-section relative h-[15em] md:h-[8em]">
        <motion.div className=''>
          ...
          <ul className="socials left-0 right-0 p-8 bottom-[2em] absolute w-[auto] justify-center md:justify-start">
              <li><a href="https://www.instagram.com/ginevarlabs/"><i className="fa-brands fa-instagram instagram"></i></a></li>
              <li><a href="https://github.com/Ginevar-Labs"><i className="fab fa-github whatsapp"></i></a></li>
              <li><a href="https://www.linkedin.com/company/ginevar"><i className="fa-brands fa-linkedin twitter"></i></a></li>
          </ul>
          <p className="absolute p-8 w-[17em] bottom-[2em] left-[25%]  text-center text-md ginlabs hidden min-[1665px]:block">Ginevar Labs</p>
          <div className='flex justify-center'>
            <div className=" min-[525px]:block absolute  md:right-[1em] bottom-[4.5em] md:bottom-[3em] overflow-hidden">
                  <a onClick={()=>{window.scrollTo(0, 0)}} id='contactButton ' className="cta flex" href="#">
