  ...
  <div className='h-[40vh] overflow-hidden hidescrollbar'>
    ...
    <div id="section2" className="gsap-section relative">
        <motion.div className=''>
          <img className="p-8 absolute w-[2em] left-[2em] min-[700px]:top-[1em]" src="\gllogolight.svg"/>
          ...
          <ul className="socials left-0 right-0 p-8 absolute w-[auto] ">
          ...
          <div className="hidden min-[525px]:block absolute right-[2em] md:right-[2em] bottom-[5em] md:bottom-[3em]">
