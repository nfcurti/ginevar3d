...
export function Overlay() {
  return (
    <>
      ...
      <div style={{ position: 'absolute', bottom: 70, left: 120, fontSize: '20px', fontFamily:"SFCSB", letterSpacing:"2px" }}>
      ...
      <div style={{ position: 'absolute', bottom: 70, right: 120, fontSize: '20px', fontFamily:"SFCSB", letterSpacing:"2px" }}>
        <img src="/bubblecomic.svg" alt="bubbols" />
      </div>
    </>
  )
}
