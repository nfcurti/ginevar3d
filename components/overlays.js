...
export function Overlay() {
  ...
  return (
    <>
      ...
      <motion.div 
      id='moreText' 
      className='chamuyo min-[680px]:bottom-[-10em] max-[680px]:bottom-[-325px] min-[680px]:text-[1em] min-[1800px]:right-[5em] max-[680px]:text-[1vhngr] max-[650px]:p-8 max-[650px]:pt-16 max-[1800px]:left-0 max-[1800px]:right-0' 
