...
export default function NavMenu(){
    ...
    useEffect(()=>{
      ...
      function startAnimation(){
        var buttonsObject = document.getElementById('buttonsWrapper');
        gsap.fromTo(buttonsObject, { opacity: 0}, {opacity: 1, duration: 1, delay:3});
      } 
    ...
    return <>
      <motion.div id='buttonsWrapper' >
            ...
            <div className="absolute justify-center fixed top-[1.5em]  right-[2em]  min-[1070px]:flex min-[1800px]:right-[18em]">
                <a id='portfolioButton' className="cta hidden md:flex max-[1070px]:mb-[0.25em]" href="#portfolio">
                  <span>PORTFOLIO</span>
                  <span>
                ...
                <a id='aboutButton' className="cta ml-8 buttontr hidden md:flex max-[1070px]:mb-[0.25em]" href="#">
                  <span>ABOUT</span>
                  <span>
                    <svg width="66px" height="43px" viewBox="0 0 66 43" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                      <g id="arrow" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                ...
                <a id='asdButton ' className="cta ml-8 flex md:hidden max-[1070px]:mb-[0.25em]" href="#">
                  <span>
